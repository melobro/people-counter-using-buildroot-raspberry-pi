...
#define ADDITIONAL_LED_PIN_NUM 25
...
int main() {
    ...
    while (1) {
        ...
        if (count > 1) {
            set_value(1, ADDITIONAL_LED_PIN_NUM);
        } else {
            set_value(0, ADDITIONAL_LED_PIN_NUM);
        }
...
void setup_sensors() {
    ...
    export_pin(ADDITIONAL_LED_PIN_NUM);
    set_direction(OUT, ADDITIONAL_LED_PIN_NUM);
}
