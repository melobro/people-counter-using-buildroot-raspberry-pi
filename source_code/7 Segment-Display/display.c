...
/**
 * @brief Function to activate GPIO pins (CLK and DIO) for communication with the display.
 */
...
/**
 * @brief Function to deactivate GPIO pins after communication with the display.
 */
...
/**
 * @brief Function to set CLK pin value to HIGH.
 */
void display_clk_high() { set_value(HIGH, CLK); }

/**
 * @brief Function to set CLK pin value to LOW.
 */
void display_clk_low() { set_value(LOW, CLK); }

/**
 * @brief Function to set DIO pin value to HIGH.
 */
void display_dio_high() { set_value(HIGH, DIO); }

/**
 * @brief Function to set DIO pin value to LOW.
 */
void display_dio_low() { set_value(LOW, DIO); }

/**
 * @brief Function to start a communication command.
 */
...
/**
 * @brief Function to end a communication command.
 */
...
/**
 * @brief Function to read a bit and transmit it over CLK and DIO pins.
...
/**
 * @brief Function to transmit a command to the display.
 * @param tx_data The command to be transmitted.
 */
...
/**
 * @brief Function to transmit data to the display.
 * @param tx_data The data to be transmitted.
...
/**
 * @brief Function to turn on the display.
 */
void display_on()
{
...
/**
 * @brief Function to turn off the display.
 */
void display_off()
{
    uint8_t buffer[4] = {0}; // Buffer for data
...
/**
 * @brief Function to handle the display based on an array of 4 values.
...
/**
 * @brief Function to convert numbers to their display segments.
 * @param data The number to be converted.
 * @return The display segment corresponding to the number.
 */
...
/**
 * @brief Function to reset the display values to zero.
 * @param array The array of values to be reset.
 */
...
/**
 * @brief Function to increment the display value at a specific position.
 * @param array The array of values to be incremented.
 * @param num The position at which to increment the value.
 */
...
/**
 * @brief Function to decrement the display value at a specific position.
 * @param array The array of values to be decremented.
 * @param num The position at which to decrement the value.
 */
...
/**
 * @brief Function to show an Error if more than 2 people want to enter simultaneously.
 * @param array The array of values representing the error.
 */
